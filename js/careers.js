...
function setupSmoothScrolling() {
    ...
    links.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // For external links (like to index.html or Microsoft Forms), let default behavior happen
        });
    });
}
...
// Add CSS for ripple effect (this part is already in index.js, but duplicated for careers.js for self-containment)
